...
const RestaurentCard = ({resData}) => {
  ...
  return (
    <div className="rest-cards" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        className="rest-img"
        src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + resData.info.cloudinaryImageId} alt="rest-logo"
      />
      <div className="card-descr">
        ...
        <span>
          ...
          <i className="fa-solid fa-star"></i>
          <i className="fa-regular fa-star"></i> <b>{avgRating}</b>
        </span>
